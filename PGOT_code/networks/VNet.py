...
class Decoder(nn.Module):
    def __init__(self, n_channels=1, n_classes=2, n_filters=32, normalization='batchnorm', has_dropout=False, has_residual=False):
        super(Decoder, self).__init__()
        self.has_dropout = has_dropout
        convBlock = ConvBlock if not has_residual else ResidualConvBlock

        upsampling = Upsampling#DeconvBlock # using transposed convolution
...
class VNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=32, normalization='none', has_dropout=False, has_residual=False):
...
class VNet_prob(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=32, outdim=128,normalization='none', has_dropout=False,
                 has_residual=False):
    ...
    def forward(self, input):
        ...
        return out_seg, representation  # 4, 16, 112, 112, 80
