...
class MCNet3d_v1(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, outdim=16, normalization='none', has_dropout=False, has_residual=False):
    ...
    def forward(self, input):
        features = self.encoder(input)
        out_seg1, x9_1 = self.decoder1(features)
        out_seg2, x9_2 = self.decoder2(features)
        #representation = self.representation(x9_2)
        return out_seg1, out_seg2, x9_1, x9_2
